...
class ManualIngredientInputScreen extends StatefulWidget {
  ...
  @override
  State<ManualIngredientInputScreen> createState() => _ManualIngredientInputScreenState();
}

class _ManualIngredientInputScreenState extends State<ManualIngredientInputScreen> {
          ...
          children: [
            ...
            Expanded(
              child: TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Water, Glycerin, Prunus Amygdalus Dulcis Oil, Fragrance',
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                child: Text(_isSubmitting ? 'Checking...' : 'Check Ingredients'),
              ),
            ),
          ],
        ),
