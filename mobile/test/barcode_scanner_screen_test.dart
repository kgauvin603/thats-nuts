...
void main() {
  testWidgets('renders scanner guidance and fallback actions',
    ...
    expect(
        find.text('Point the camera at a UPC or EAN barcode.'), findsOneWidget);
    expect(
      find.text(
    ...
    expect(find.text('Supported formats: UPC-A, UPC-E, EAN-8, EAN-13.'),
        findsOneWidget);
  });
}
